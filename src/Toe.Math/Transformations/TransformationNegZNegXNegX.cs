...
{
    public class TransformationNegZNegXNegX : AbstractTransformation
    {
        public static readonly TransformationNegZNegXNegX Instance = new TransformationNegZNegXNegX();
