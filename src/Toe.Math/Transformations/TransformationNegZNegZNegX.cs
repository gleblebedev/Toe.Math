...
{
    public class TransformationNegZNegZNegX : AbstractTransformation
    {
        public static readonly TransformationNegZNegZNegX Instance = new TransformationNegZNegZNegX();
