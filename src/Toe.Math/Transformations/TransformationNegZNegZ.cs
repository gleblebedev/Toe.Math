...
{
    public class TransformationNegZNegZ : AbstractTransformation
    {
        public static readonly TransformationNegZNegZ Instance = new TransformationNegZNegZ();
        public static readonly Quaternion Quaternion = new Quaternion(0f, 0f, -1f, 0f);
