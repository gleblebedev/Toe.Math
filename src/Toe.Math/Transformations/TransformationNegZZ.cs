...
{
    public class TransformationNegZZ : AbstractTransformation
    {
        public static readonly TransformationNegZZ Instance = new TransformationNegZZ();
        public static readonly Quaternion Quaternion = new Quaternion(0f, 0f, 0f, 1f);
