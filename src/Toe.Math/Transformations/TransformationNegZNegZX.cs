...
{
    public class TransformationNegZNegZX : AbstractTransformation
    {
        public static readonly TransformationNegZNegZX Instance = new TransformationNegZNegZX();

        public static readonly Quaternion Quaternion = new Quaternion(0f, 0.70710678118654752440084436210485f,
            -0.70710678118654752440084436210485f, 0f);

        public static readonly Matrix4 Matrix = new Matrix4(-1f, 0f, 0f, 0f, 0f, 0f, -1f, 0f, 0f, -1f, 0f, 1f, 0f, 0f,
            0f, 1f);
